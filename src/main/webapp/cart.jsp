...
<%@page import="bookshop.nurozkaya.connection.DbCon"%>
...
<!-- total price and checkout -->
		...
		<!-- table to display all the cart prods -->
		<table class="table table-light">
			...
			<tbody>
			<!-- sepete eklenen kitabın özellikleri row -->
			<%
				if (cart_list != null) {
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" name="id" value="<%= c.getId()%>" class="form-input">
							...
							<!-- small increm btn to see quantity -->
